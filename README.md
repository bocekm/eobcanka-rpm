...
CZ: Postup je otestovaný s Fedorou 44 a s verzí DEB balíčku 3.5.2.

EN: Tested on Fedora 44 with the version of the DEB package 3.5.2.  The app itself is not translated, so a quick translation:
